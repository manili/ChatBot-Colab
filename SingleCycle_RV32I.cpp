...
public:
    ...
    uint32_t rf[32]; // 32 registers of 32-bit register-file
...
//=============================================================================================================//
    ...
    cpu.i_cache[0x00000010] = 0b00000000001100000000000000100011; //== sb     x3      ,   0(x0)              ==//
    cpu.i_cache[0x00000014] = 0b00000000000000000000001000000011; //== lb     x4      ,   0(x0)              ==//
    cpu.i_cache[0x00000018] = 0b00000000000000000100001010000011; //== lbu    x5      ,   0(x0)              ==//
...
//=============================================================================================================//
    ...
    cpu.i_cache[0x00000028] = 0b00000000001000000001000000100011; //== sh     x2      ,   0(x0)              ==//
